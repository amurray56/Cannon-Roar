...
////// Emissive:
                ...
                float4 node_8829 = _Time;
                float _TurbulanceScale_var = UNITY_ACCESS_INSTANCED_PROP( Props, _TurbulanceScale );
                float2 node_8977 = ((i.uv0*_TurbulanceScale_var)+node_8829.g*float2(0.01,0.01));
